<?php $__env->startSection('title', 'Dashboard Executive Bos — SIResto'); ?>
...
<div class="space-y-6">
    ...
    <div class="bg-white p-5 rounded-2xl shadow-sm border border-slate-200 space-y-3">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <a href="<?php echo e(route('pelayan.order.form')); ?>" class="p-3 bg-amber-50 border border-amber-200 rounded-xl hover:bg-amber-100 transition flex items-center justify-between text-amber-900">
                <span class="font-bold text-xs">📋 Modul Pelayan (Order)</span>
                <span class="text-xs">➔</span>
            </a>
            <a href="<?php echo e(route('koki.kds')); ?>" class="p-3 bg-red-50 border border-red-200 rounded-xl hover:bg-red-100 transition flex items-center justify-between text-red-900">
                <span class="font-bold text-xs">🔥 Modul Dapur (KDS Koki)</span>
                <span class="text-xs">➔</span>
            </a>
            <a href="<?php echo e(route('kasir.index')); ?>" class="p-3 bg-blue-50 border border-blue-200 rounded-xl hover:bg-blue-100 transition flex items-center justify-between text-blue-900">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
            ...
            <p class="text-3xl font-black font-mono text-emerald-600 mt-2">Rp <?php echo e(number_format($totalPendapatanHariIni, 0, ',', '.')); ?></p>
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
            ...
            <p class="text-3xl font-black text-blue-600 mt-2"><?php echo e($totalPesananHariIni); ?> <span class="text-base font-normal text-slate-500">Pesanan</span></p>
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
            ...
            <p class="text-3xl font-black text-amber-600 mt-2"><?php echo e($totalMenuAktif); ?> <span class="text-base font-normal text-slate-500">Item</span></p>
    ...
    <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 space-y-6">
        <div class="flex flex-col md:flex-row md:items-center justify-between border-b border-slate-100 pb-4 gap-4">
            ...
            <form action="<?php echo e(route('pemilik.laporan.generate')); ?>" method="POST" class="flex items-center space-x-2">
                <?php echo csrf_field(); ?>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left text-xs text-slate-600">
                ...
                <tbody class="divide-y divide-slate-100">
                    <?php $__empty_1 = true; $__currentLoopData = $laporanList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-slate-50">
                            <td class="p-3 font-mono font-bold text-slate-900"><?php echo e($lap->no_laporan); ?></td>
                            <td class="p-3 capitalize font-semibold"><?php echo e($lap->periode_laporan); ?></td>
                            <td class="p-3"><?php echo e($lap->tgl_awal); ?> s/d <?php echo e($lap->tgl_akhir); ?></td>
                            <td class="p-3 font-mono font-extrabold text-emerald-600">Rp <?php echo e(number_format($lap->total_pendapatan, 0, ',', '.')); ?></td>
                            <td class="p-3"><?php echo e($lap->tgl_cetak); ?></td>
                            <td class="p-3">
                                <span class="px-2 py-0.5 text-[10px] font-bold rounded uppercase
                                    <?php echo e($lap->status_validasi === 'tervalidasi' ? 'bg-emerald-100 text-emerald-800' : 'bg-amber-100 text-amber-800'); ?>">
                                    <?php echo e($lap->status_validasi); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ArtvAdmirer\.gemini\antigravity\scratch\siresto\resources\views/pemilik/dashboard.blade.php ENDPATH**/ ?>